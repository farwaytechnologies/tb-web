  ...
  return (
    <div className="ref-page">
      <div className="ref-header">
        <div className="ref-header-glow" style={{ '--glow-color': '139,92,246' }} />
        <Gift size={28} className="ref-header-icon" style={{ color: '#8b5cf6' }} />
        <div>
          <h1 className="ref-title">Referral Program</h1>
          <p className="ref-subtitle">Invite tutors & students, earn bonus points</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="ref-stats">
            <div className="ref-stat-card" style={{ '--c': '#8b5cf6' }}>
            ...
            <div className="ref-stat-card" style={{ '--c': '#f59e0b' }}>
              <TrendingUp size={20} style={{ color: '#f59e0b' }} />
              <span className="ref-stat-val">{data?.pointsFromReferrals || 0}</span>
              <span className="ref-stat-lbl">Bonus Points Earned</span>
            </div>
          ...
          <div className="ref-how">
            ...
            <div className="ref-steps">
              {[
                { n: '1', text: 'Share your referral link with anyone' },
                { n: '2', text: 'They register using your link' },
                { n: '3', text: 'You earn 25 bonus points instantly' },
              ].map(s => (
